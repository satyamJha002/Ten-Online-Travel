export const andmatour = [
    {
      ...
      qna: [
       {
          question: "Day 1 :Arrival at Port Blair | Cellular jail | Light & Sound Show",
          answer:
        ...
        {
          question:
            "Day 2 :Port Blair to Havelock Island | Radha Nagar Beach",
          answer:
        ...
        {
          question:
            "Day 3 :Elephant Beach, Havelock Island",
          answer:
        ...
        },
        {
          ...
          answer:"After leaving the hotel, take a first-class boat to Neil Island, where a representative will transport you to the appropriate resort. Take a break before continuing on to Bharatpur Beach and Laxmanpur Beach, which is a remote beach located 2 km north of Neil Jetty. Stay to see the captivating sunset and take in the natural coral bridge.",
        },
        {
          question: "Day 5 :NEIL TO PORT BLAIR IN CRUISE",
          answer: "We catch a boat back to Port Blair after breakfast. When you arrive, a representative will greet you and accompany you to the hotel to check in. Leisure for shopping is free in the evening.",
        },
        {
          question: " Day 6 :Airport Drop",
          answer: "After breakfast, depart from the hotel and be sent off at the airport. Bring back fond memories of this wonderful trip to the Andaman Islands.",
        },
      ...
      hotelData : [
        ...
        {
          location: "Havelock",
          names: "Haywizz Havelock Beach Resort / Symphony Palm Beach Resort / TSG Blue",
          roomType: "Double Room",
        },
        {
      ...
      availableActivities: [
        { location: "Port Blair", activity: "Scuba Diving", cost: "₹4000 / Head" },
        {
          location: "Port Blair",
          activity: "Underwater Sea Walking",
          cost: "₹4000 / Head",
        },
        { location: "Havelock", activity: "Game Fishing", cost: "₹15000 / Six Pax" },
        { location: "Neil", activity: "Glass Bottom Boat Ride", cost: "₹500 / Head" },
      ],
      ...
      qna: [
       {
        ...
        {
          question:
           "Day 3 :HAVELOCK ISLAND → PORT BLAIR IN CRUISE",
          answer:"We catch a boat back to Port Blair after breakfast. When you arrive, a representative will greet you and accompany you to the hotel to check in. Leisure for shopping is free in the evening.",
        },
      ...
      qna: [
       {
        ...
        },
        {
          ...
          answer: "Take the rest of the day off after breakfast. At Neil Island, you may participate in a variety of water sports.",
        },
        {
      ...
      qna: [
       {
        ...
        }, 
        {
          ...
          answer:"Breakfast is served in the morning, and the rest of the day is spent relaxing. Today, you may visit Elephant Beach, Kala Patthar Beach, and Radhanagar Beach. Or just unwind at your resort by the sea.",
        },
        {
          question:"Day 4 :HAVELOCK TO PORT BLAIR IN CRUISE",
          answer:"We head back in the morning to catch a boat to Port Blair. Our agent will meet you when you arrive and drive you to the hotel so you can check in.",
        },
       
        {
          question: " Day 5 :Airport Drop",
          answer: "Drop off to the airport. Bring back fond recollections of this far-flung location.***** THE TOUR CONTINUES WITH GLADABLE MEMORY! *****",
        },
      ...
      qna: [
       {
        ...
        {
          question:
            "Day 3 : AT LEISURE | Elephant Beach (Optional Activity)",
          answer:
          "Enjoy a day off. Why don't you unwind in the middle of nature? You are free to unwind and enjoy white sand beaches today. This day may also be used for other activities like sea walks and snorkeling/scuba diving. Even if you're not good at swimming, you may still participate in these activities.We return you to your resort after this so you can rest and recuperate.",
        },
        {
      ...
      qna: [
       {
        ...
        {
          question: "Day 5 :NEIL Island| Day at Leisure",
          answer: "After Breakfast, spend Rest of the day at leisure. You can do various available water sports activities at Neil Island.",
        },
