  ...
  return (
    ...
    <g>
        <g opacity=".86">
            ...
            <p>New Delhi, India</p>
            <p>Email: <a href="mailto:info@entrepreneurshipnetwork.net" className="text-yellow-400 hover:underline">info@entrepreneurshipnetwork.net</a></p>
          </div>
          ...
          <div className="flex-1">
            ...
            <ul className="mt-2 space-y-2">
              ...
              <li><a href="/india" className="text-gray-400 hover:text-yellow-400">India</a></li>
              <li><a href="/international" className="text-gray-400 hover:text-yellow-400">International</a></li>
              <li><a href="/activities" className="text-gray-400 hover:text-yellow-400">Activities</a></li>
          ...
          <div className="flex-1">
            ...
            <ul className="mt-2 space-y-2">
              <li><a href="/PrivacyPolicy" className="text-gray-400 hover:text-yellow-400">Privacy Policy</a></li>
              <li><a href="/Termpage" className="text-gray-400 hover:text-yellow-400">Terms and Conditions</a></li>
              <li><a href="/DocumentVisa" className="text-gray-400 hover:text-yellow-400">Documents Collection & Visa</a></li>
