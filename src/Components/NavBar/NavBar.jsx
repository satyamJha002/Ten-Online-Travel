...
const Navbar = () => {
  ...
  const [isInternationalSubmenuOpen, setInternationalSubmenuOpen] =
    useState(false);
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (
        indiaMenuRef.current &&
        !indiaMenuRef.current.contains(event.target) &&
        indiaDropdownRef.current &&
        !indiaDropdownRef.current.contains(event.target)
      ) {
        setIndiaSubmenuOpen(false);
      }

      if (
        internationalMenuRef.current &&
        !internationalMenuRef.current.contains(event.target) &&
        internationalDropdownRef.current &&
        !internationalDropdownRef.current.contains(event.target)
      ) {
      ...
      <div className="hidden md:flex justify-center items-center bg-green-400 px-6 py-4 shadow-md">
        <div className="flex gap-3">
          ...
          <div className="relative mx-2">
            ...
            {isIndiaSubmenuOpen && (
              <div
                className="absolute  bg-green-400 mx-2 w-40 shadow-lg z-50 mt-4"
                ref={indiaDropdownRef}>
                <NavLink
                  to="/andaman-tour"
                  className={({ isActive }) =>
                    `${
                ...
                {isHimachalSubmenuOpen && (
                  <div className="absolute left-full top-16 bg-green-400 shadow-lg z-50">
                    <NavLink
                      ...
                      <button
                        className="block  justify-center items-center px-4 py-2 text-left   hover:bg-green-400"
                        onClick={() => {
                          setIndiaSubmenuOpen(false);
                ...
                {isKeralaSubmenuOpen && (
                  <div className="absolute left-full my-3 bg-green-400 top-24 shadow-lg z-50">
                    <NavLink
                      ...
                      <button
                        className="block  px-4 py-2 text-left hover:bg-green-400"
                        onClick={() => {
                          setIndiaSubmenuOpen(false);
                ...
                {isTamilNaduSubmenuOpen && (
                  <div className="absolute left-full top-32  my-4 bg-green-400 shadow-lg z-50">
                    <NavLink
                      ...
                      <button
                        className="block px-4  py-2 text-center hover:bg-green-400"
                        onClick={() => {
                          setIndiaSubmenuOpen(false);
                    ...
                    <NavLink
                      ...
                      <button
                        className="block px-2   py-2 text-center hover:bg-green-400"
                        onClick={() => {
                          setIndiaSubmenuOpen(false);
                          setTamilNaduSubmenuOpen(false);
                        }}>
          ...
          <div className="relative mx-2 ">
            <div className="flex">
              ...
              <button
                className={`${inactiveStyle} no-underline hover:no-underline focus:no-underline`}
                onClick={() =>
                  setInternationalSubmenuOpen(!isInternationalSubmenuOpen)
                }
            ...
            {isInternationalSubmenuOpen && (
              <div
                className="absolute left-20 bg-green-400 justify-center items-center shadow-lg z-50 mt-4"
                ref={internationalDropdownRef}>
                <NavLink
          ...
          <div className="relative mx-2">
            <div className="flex">
              ...
              <button
                className={`${inactiveStyle} no-underline hover:no-underline focus:no-underline`}
                onClick={() =>
                  setActivitiesSubmenuOpen(!isActivitiesSubmenuOpen)
                }
            ...
            {isActivitiesSubmenuOpen && (
              <div
                className="absolute w-18 left-8 bg-green-400 shadow-lg z-50 mt-4"
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `${
                isActive ? activeStyle : inactiveStyle
              } no-underline mx-2 hover:no-underline focus:no-underline`
            }>
            REVIEWS
          </NavLink>
          <NavLink
          ...
          <div className="absolute my-2 left-0 w-full bg-green-500 text-white p-4  z-50">
            <div className="">
              <NavLink
                ...
                <button
                  className="block py-2 text-left font-medium"
                  onClick={() => setMobileMenuSubmenuOpen(!isIndiaSubmenuOpen)}>
                  HOME
                </button>
              </NavLink>
              <div className="flex">
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `${
                      isActive ? activeStyle : inactiveStyle
                    } block py-2 text-left font-medium no-underline hover:no-underline focus:no-underline`
                  }>
              ...
              {isIndiaSubmenuOpen && (
                <div className="ml-4" ref={indiaDropdownRef}>
                  <NavLink
                    ...
                    onClick={() =>
                      setMobileMenuSubmenuOpen(!isIndiaSubmenuOpen)
                    }>
                    <button className="block py-2 text-left">
                      Andaman Tour
                    </button>
                  </NavLink>
                  <div className="flex">
            ...
            <div>
              <div className="flex">
                <button
                  className={`${
                    isInternationalSubmenuOpen ? activeStyle : inactiveStyle
                  } block py-2 text-left font-medium no-underline hover:no-underline focus:no-underline`}
                  onClick={() =>
                    setInternationalSubmenuOpen(!isInternationalSubmenuOpen)
                  }>
              ...
              {isInternationalSubmenuOpen && (
                <div ref={internationalDropdownRef}>
                  <NavLink
                    ...
                    onClick={() =>
                      setMobileMenuSubmenuOpen(!isInternationalSubmenuOpen)
                    }>
              ...
              {isActivitiesSubmenuOpen && (
                <div ref={activitiesDropdownRef}>
                  <NavLink
                    ...
                    onClick={() =>
                      setMobileMenuSubmenuOpen(!isActivitiesSubmenuOpen)
                    }>
                    <button className="block py-2 text-left">
                      River Rafting
                    </button>
